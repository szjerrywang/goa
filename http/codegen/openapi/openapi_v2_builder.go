...
// expression.
func ExtensionsFromExpr(mdata expr.MetadataExpr) map[string]interface{} {
...
func mustGenerate(meta expr.MetadataExpr) bool {
...
func tagsFromExpr(mdata expr.MetadataExpr) (tags []*Tag) {
	var keys []string
	for k := range mdata {
		keys = append(keys, k)
	}
...
func tagNamesFromExpr(mdatas ...expr.MetadataExpr) (tagNames []string) {
...
func summaryFromMetadata(name string, metadata expr.MetadataExpr) string {
