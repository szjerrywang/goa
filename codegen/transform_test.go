...
var (
	...
	ObjWithMetadata = withMetadata(object("a", SimpleMap.Type, "b", expr.Int), "a", metadata("struct:field:name", "Apple"))
...
func withMetadata(att *expr.AttributeExpr, vals ...interface{}) *expr.AttributeExpr {
